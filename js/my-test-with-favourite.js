 ...
 */
 (function ($) {
    ...
    // custom
    var favorite_url    = "https://balirealestateconsultants.com/my-favorites"
...
function ajax_favorite() {
    ...
    add_to_favorite(favorite_url, listings_favorite)
    // remove_favorite(favorite_url, listings_favorite)
    // remove_from_favorite(listings_favorite, favorite_add_icon, favorite_remove_icon, add_favorite_text, remove_favorite_text);
}
...
// CUSTOM FUNCTION ADD TO FAVORITE (COOKIE)
function add_to_favorite(favorite_url, listings_favorite) {
    var listings_favorite = houzezGetCookie('houzez_favorite_listings');
    ...
    if ( listings_favorite && listings_favorite.length ) {
        ...
        if ( listings_favorite.length ) {
            ...
            // Custom text
            jQuery("span.elementor-size-small").html("")
            jQuery("p.elementor-size-small").html("")
            jQuery("span.elementor-size-small").append("<a href='" + favorite_url + "'> My Favorites " + "(" + listings_favorite.length + ") </a>");
            jQuery("p.elementor-size-small").append("<a href='" + favorite_url + "'> My Favorites " + "(" + listings_favorite.length + ") </a>");

            // Custom heading 
            // for (let i = 1; i <= 6; i++) {
            //     jQuery("h" + i + ".elementor-size-small").html("")
            //     jQuery("h" + i + ".elementor-size-small").append("<a href='" + favorite_url + "'> My Favorites " + "(" + listings_favorite.length + ") </a>");
            // }

            // jQuery("h5.elementor-size-small").html("")
            // jQuery("h5.elementor-size-small").append("<a href='" + favorite_url + "'> My Favorites " + "(" + listings_favorite.length + ") </a>");
            // jQuery("h5.elementor-size-small > a").attr("href", favorite_url)
        }
    } else {
        listings_favorite = [];
    }
...
jQuery(document).ready(function(e) {
    jQuery(document).on('click',function(e) {
        if (jQuery(e.target).is('#houzez-listing-lightbox')) {
            setTimeout(function() {
                console.log("ajax favorite loaded")
                ajax_favorite()
            }, 1000);
        }
    })

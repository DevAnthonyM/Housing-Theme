...
<ul class="list-unstyled list-inline author-meta flex-grow-1">
	...
	<li class="list-inline-item">
		<img class="img-fluid rounded-circle mr-2" src="<?php echo esc_url( get_the_author_meta( 'fave_author_custom_picture' ) );?>" width="40" height="40" alt="<?php echo esc_attr( get_the_author() ); ?>"> <?php echo $houzez_local['by_text']; ?> <?php echo esc_attr( get_the_author() ); ?>
	</li>
	<?php } ?>
